...
1. The script will analyze the data and calculate the following metrics: <p>
  ...
  <p>
2. The final script prints the analysis to the terminal and exports a text file [results](https://github.com/chelseasenter/python-challenge/blob/main/PyBank/Analysis/results.txt) with the results<p>
